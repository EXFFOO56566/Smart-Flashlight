...
import com.codingstudio.smartflashlight.flip.AnimationFactory;
import com.codingstudio.smartflashlight.flip.AnimationFactory.FlipDirection;
...
public class FragFlashLight extends Fragment implements OnKeyListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		try {
			...
			imageView = (ImageView)v.findViewById(R.id.image_bulb);
			imageView.setImageDrawable(getResources().getDrawable(R.drawable.bulb_off));
					...
					if (flashSupport) {
						...
						try {
							if (on) {
								...
								imageView.setImageDrawable(getResources().getDrawable(R.drawable.bulb_on));
							} else {
	...
	public Runnable TorchlightOn = new Runnable() {
		@Override 
		public void run() {
	...
	public void startTorchlightOn() {
		TorchlightOn.run();

	}

	public void stopTorchlightOn() {
		handler.removeCallbacks(TorchlightOn);

	}

	public Runnable TorchlightOff = new Runnable() {
		@Override 
		public void run() {
	...
	public void startTorchlightOff() {
		TorchlightOff.run(); 
	}

	public void stopTorchlightOff() {
